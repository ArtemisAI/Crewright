...
- **[LangDB](https://docs.crewai.com/en/observability/langdb)** - End-to-end tracing for CrewAI workflows with automatic agent interaction capture
- **[OpenLIT](https://docs.crewai.com/en/observability/openlit)** - OpenTelemetry-native monitoring with cost tracking and performance analytics
- **[MLflow](https://docs.crewai.com/en/observability/mlflow)** - Machine learning lifecycle management with tracing and evaluation capabilities
- **[Langfuse](https://docs.crewai.com/en/observability/langfuse)** - LLM engineering platform with detailed tracing and analytics
- **[Langtrace](https://docs.crewai.com/en/observability/langtrace)** - Open-source observability for LLMs and agent frameworks
- **[Arize Phoenix](https://docs.crewai.com/en/observability/arize-phoenix)** - AI observability platform for monitoring and troubleshooting
- **[Portkey](https://docs.crewai.com/en/observability/portkey)** - AI gateway with comprehensive monitoring and reliability features
- **[Opik](https://docs.crewai.com/en/observability/opik)** - Debug, evaluate, and monitor LLM applications with comprehensive tracing
- **[Weave](https://docs.crewai.com/en/observability/weave)** - Weights & Biases platform for tracking and evaluating AI applications

### Evaluation & Quality Assurance

- **[Patronus AI](https://docs.crewai.com/en/observability/patronus-evaluation)** - Comprehensive evaluation platform for LLM outputs and agent behaviors
