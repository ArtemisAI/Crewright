...
Before we proceed, make sure you have finished installing CrewAI. If you haven't installed them yet, you can do so by following the [installation guide](https://docs.crewai.com/en/installation).
...
### 7. Feel free to pass custom inputs to your crew
...
- The configuration for your choice of model, such as an API key. See the [LLM setup guide](https://docs.crewai.com/en/concepts/llms#setting-up-your-llm) to learn how to configure models from any provider.

### 9. Lock and install the dependencies
...
### 11. Enterprise Alternative: Create in Crew Studio
...
**[Try CrewAI AOP](https://app.crewai.com/)**: Start your free account at CrewAI AOP

### 12. View your final report
...
- **Enhanced Decision-Making**: AI agents can analyze trends and patterns in data, provide insights, and even suggest actions, helping stakeholders make informed decisions based on factual data rather than intuition.
...
**[Deploy on Enterprise](http://app.crewai.com/)**: Get started with CrewAI AOP and deploy your crew in a production environment with just a few clicks.

**[Join the Community](https://community.crewai.com/)**: Join our open source community to discuss ideas, share your projects, and connect with other CrewAI developers.