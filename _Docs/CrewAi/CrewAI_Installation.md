...
⚠️ If you encounter a `PATH` warning, run this command to update your shell:

```bash
uv tool update-shell
```

⚠️ If you encounter the `chroma-hnswlib==0.7.6` build error (`fatal error C1083: Cannot open include file: 'float.h'`) on Windows, install [Visual Studio Build Tools](https://visualstudio.microsoft.com/downloads/) with Desktop development with C++.
...
- **[Build Your First Agent](https://docs.crewai.com/en/quickstart)**: Follow our quickstart guide to create your first CrewAI agent and get hands-on experience
